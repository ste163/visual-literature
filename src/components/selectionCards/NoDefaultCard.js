...
export const NoDefaultCard = () => {
    ...
    return (
        <section className="card card__color--white card__noDefault">
            ...
            <p className="noDefault__p">Select a <strong>project</strong> from <strong>drop-down menu</strong>{defaultProject !== 0 ? null : (<> or set a <strong>default project</strong> from <strong>settings menu</strong></>)}.</p>
        </section>
    )
}