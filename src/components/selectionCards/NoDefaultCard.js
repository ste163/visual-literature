...
export const NoDefaultCard = () => {
    ...
    return (
        <section className="card card__color--white card__noDefault">
            ...
            <p className="noDefault__p">Select a project from the <strong>drop-down menu</strong>{defaultProject !== 0 ? null : (<> or set a <strong>default project</strong> from the <strong>settings menu</strong></>)}.</p>
        </section>
    )
}
